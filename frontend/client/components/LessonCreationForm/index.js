...
class LessonCreationForm extends Component {
  static propTypes = {
  ...
  onLessonTypeChanged(e, i, value) {
    this.setState({ selectedLessonType: value })
  }
  ...
  renderHiddenFields() {
    ...
    const multipleChoice = selectedLessonType
      ? selectedLessonType === questionTypeMultipleChoice
      : null
  ...
  renderAnswerField() {
    const { selectedLessonType } = this.state
    ...
    return (
      <div className={style.main}>
        <form ref="form" encType="multipart/form-data">
          ...
          <div>
            <div className={style.label}>Lesson Requirements</div>
            <Checkbox
          ...
          <SelectField
            ...
            onChange={::this.onLessonTypeChanged}
            fullWidth={true}
            floatingLabelText="Lesson Type">
            <MenuItem
          ...
          <div className={style.pictures}>
            <div>
              <div className={style.label}>Lesson Picture</div>
              <input
            ...
            <div>
              <div className={style.label}>Lesson Answer</div>
              <input
                name="answerPicture"
                type="file"
                accept="image/*;capture=camera" />
          ...
          <TextField
            ...
            fullWidth={true}
            floatingLabelText="Lesson Source Page" />
          <TextField
