...
public class GSheetProblemsImporter implements IGSheetProblemsImporter{
    ...
    public Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
        		GSheetProblemsImporter.class.getResourceAsStream("/client_secret_990534510525-40rqklbe7l474sddfff0l2dj74oqg4ev.apps.googleusercontent.com.json");
    ...
    public static void main(String[] args) throws IOException {
        ...
        Sheets service = new GSheetProblemsImporter().getSheetsService();
