...
public class AWSSESMailServiceImpl implements IMailService, ManagedService {
	public static final String MAIL_SMTP_SERVER_HOSTNAME = "aws.ses.smtp.hostname";
	public static final String MAIL_SMTP_SERVER_PORT= "aws.ses.smtp.port";
	public static final String MAIL_SMTP_LOGIN_USERNAME= "aws.ses.smtp.username";
	public static final String MAIL_SMTP_LOGIN_PASSWORD= "aws.ses.smtp.password";
