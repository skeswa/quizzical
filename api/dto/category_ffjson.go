...
var ffj_key_Category_Name = []byte("name")
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'n':
					...
					if bytes.Equal(ffj_key_Category_Name, kn) {
						currentKey = ffj_t_Category_Name
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.SimpleLetterEqualFold(ffj_key_Category_Name, kn) {
					currentKey = ffj_t_Category_Name
					state = fflib.FFParse_want_colon
					goto mainparse
				}
